  ...
  return (
    <div className="min-h-dvh pb-12">
      ...
      <main className="mx-auto max-w-2xl px-4 pt-4 md:max-w-4xl xl:max-w-6xl">
        ...
        <p className="mt-6 border-t border-[var(--color-border)] pt-4 text-center text-xs text-[var(--color-foreground)]/60">
          Deakin University Student Association acknowledges the Traditional Custodians of all the unceded lands,
          skies and waterways on which we come together. We pay our deep respect to the many First Nations from
          where our students come and on which we operate.
        </p>
      </main>
    </div>
  );
