...
export default function QueueTicketPanel({
  ...
  return (
    <div
      className={`mt-1 flex flex-col items-center gap-2 rounded-2xl border-2 ${compact ? "p-3" : "p-8"}`}
    ...
    >
      {ticketNumber !== null && (
        <div className="mb-1 flex flex-col items-center">
          ...
          <span
            className={compact ? "text-3xl font-extrabold" : "text-5xl font-extrabold"}
            style={{ color: COLOR_FOR[status] }}
          >
            #{ticketNumber}
          </span>
        </div>
      ...
      <h2 className={compact ? "text-base font-extrabold" : "text-xl font-extrabold"} style={{ color: COLOR_FOR[status] }}>
